...
import { FaMapMarkedAlt, FaCameraRetro, FaComments, FaPlane } from "react-icons/fa";
import { FaGlobe, FaHandsHelping, FaUpload, FaQuestionCircle, FaUser, FaSignInAlt, FaUserPlus, FaInfoCircle, FaEnvelope } from 'react-icons/fa';
...
const Home = () => {
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      >
        <div className="absolute inset-0 bg-black opacity-70"></div> {/* Darker Overlay for Better Contrast */}
        <div className="relative text-center p-10 bg-white bg-opacity-90 rounded-lg shadow-lg max-w-4xl mx-auto mt-20 mb-20">
      ...
      <section className="py-20 bg-blue-700 text-white">
        <div className="container mx-auto px-8 text-center">
          ...
          <p className="text-lg mb-8">
            Join thousands of travelers who use Travel Planner to make their adventures unforgettable.
          </p>
          <Link
            to="/signup"
            className="bg-white text-blue-700 px-10 py-5 rounded-lg shadow-lg hover:bg-gray-100 transition"
          >
            Sign Up Now
          </Link>
        </div>
